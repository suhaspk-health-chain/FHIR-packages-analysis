...
ggsave(file.path(FIG_DIR, "ver_resource_presence_heatmap.png"), add_logo_cowplot(p_heat), width = 9, height = 22, dpi = 150)
...
ggsave(file.path(FIG_DIR, "ver_resource_presence_heatmap_stable.png"), add_logo_cowplot(p_heat_stable), width = 9, height = 12, dpi = 150)
...
ggsave(file.path(FIG_DIR, "ver_resources_added.png"), add_logo_cowplot(p_added), width = 9, height = 5, dpi = 150)
...
ggsave(file.path(FIG_DIR, "ver_resources_removed.png"), add_logo_cowplot(p_removed), width = 9, height = 5, dpi = 150)
...
ggsave(file.path(FIG_DIR, "resource_adds_deletes_grid.png"), add_logo_cowplot(grid_plot), width = 16, height = 11, dpi = 150)
